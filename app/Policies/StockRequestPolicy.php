...
class StockRequestPolicy
{
    ...
    {
        return $user->can('update_stock::request');
    }
    ...
    {
        return $user->can('delete_any_stock::request');
    }
    ...
    {
        return $user->can('force_delete_stock::request');
    }
    ...
    {
        return $user->can('force_delete_any_stock::request');
    }
    ...
    {
        return $user->can('restore_stock::request');
    }
    ...
    {
        return $user->can('restore_any_stock::request');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, StockRequest $stockRequest): bool
    {
        return $user->can('replicate_stock::request');
    }
    ...
    {
        return $user->can('reorder_stock::request');
    }
}
